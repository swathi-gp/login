...
<html xmlns="http://www.w3.org/1999/xhtml"></html>
	...
	<body>
		...
		<form action='signcon/prof' method="post" name="prof">
		<table><tr><td>
		<label for="uid">UID:</label></td><td>
		<input type="text" size="20" id="uid" name="uid"/>
		</td></tr>
		<tr><td><label for="tid">TID:</label></td><td>
		<input type="text" size="20" id="tid" name="tid"/></td>
		</tr><tr><td>
			Name:</td><td>
